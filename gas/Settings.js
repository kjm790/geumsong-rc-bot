...
var SETTINGS_DEFAULTS = [
  ...
  ['회장_임기', '', '초대회장 임기(예: 2026-10-14~2028-06-30, 창립 회기+2027-28 연임)'],
  ['관리위원_정', '', '스폰서클럽 관리위원(정) — 아호 성명'],
  ['관리위원_부', '', '스폰서클럽 관리위원(부) — 아호 성명'],
  ['골프회_회장', '', '골프회(골프 회원만 참여) 회장 — 아호 성명'],
  ['골프회_총무', '', '골프회 총무 — 아호 성명 (창립 회기: 클럽 총무이사 겸임)'],
  ['문화레저동호회_회장', '', '문화레저동호회(전 회원 대상) 회장 — 아호 성명'],
